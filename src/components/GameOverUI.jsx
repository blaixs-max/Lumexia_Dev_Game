...
// DEV MODE: supabase import'u kaldirildi - skor kayit yok.
...
const GameOverUI = ({ score, totalDistance, nearMissCount, coinsCollected = 0, onRestart, onMainMenu }) => {
  ...
  // DEV MODE: skor server'a gonderilmiyor, durum sabit 'saved'.
  ...
  // DEV MODE: skor gonderim mantigi kaldirildi. Sadece konsola log basilir.
  useEffect(() => {
    const duration = Math.floor((Date.now() - startTime) / 1000);
    console.log('[DEV] Score (not submitted):', {
      finalScore,
          ...
          <div style={{
            ...
            {saveStatus === 'saved' && (
              <>
                ...
                <span style={{ color: '#6EE7B7', fontSize: '13px' }}>DEV MODE - score not submitted</span>
              </>
            )}
            {saveStatus === 'saving' && (
              <>
